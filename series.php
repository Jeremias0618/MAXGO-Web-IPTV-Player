    ...
    <div class="modal-buscador">
        ...
        <form id="modalBuscadorForm" autocomplete="off" onsubmit="return false;">
            <div class="modal-buscador-inputbox">
                <input type="text" id="modalBuscadorInput" placeholder="Buscar series, películas o canales en vivo..." autofocus>
...
// Cargar datos para búsqueda (series, películas, canales)
let peliculas = [];
let series = [];
let canales = [];
<?php
